<template>
    ...
    <w-button @click="onShowAlert">立即还款</w-button>
    
    <alert :title="alertTitle" :button-text="btnText" content='每月28日自动从您的银行卡扣款' v-model="isAlertShow"></alert>
  </div>
</template>
...
<script>
  ...
  import {  Group,Alert,Cell } from 'vux';
